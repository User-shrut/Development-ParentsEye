...
//     const response = await axios.get("https://rocketsalestracker.com/api/notifications/types", {
//       headers: {
...
const fetchData = async () => {
  ...
  try {
    ...
    const response = await axios.get("https://rocketsalestracker.com/api/notifications", {
      headers: {
        Authorization: `Basic ${token}`,
      },
    });
    ...
    if (Array.isArray(response.data)) {
      // Process data array, adding isSelected field to each item
      const wrappedData = response.data.map(item => ({ ...item, isSelected: false }));
