...
export const Server = () => {
  ...
  // const TimezoneSelect = ({ col, formData, handleInputChange }) => {
  ...
  //         setTimezones(response.data); // Assuming response.data contains an array of timezones
  //       } catch (error) {
  ...
  //   const fetchTimezones = async () => {
  //     try {
  //       const response = await fetch('https://rocketsalestracker.com/api/server/timezones', {
  //         method: 'GET',
  //         headers: {
  ...
  <Box sx={style}>
    ...
    {COLUMNS()
      ...
      .map((col) => (
        ...
        ) : col.accessor === 'attributes.altitude' && col.Header === 'Altitude' ? (
          <FormControl fullWidth sx={{ marginBottom: '10px' }} key={col.accessor}>
            ...
            {COLUMNS()
              ...
              .map((col) => (
                col.accessor === 'attributes.defaultmap' && col.Header === 'Default Map' ? (
                  ...
                  //   >
                  //     <FormGroup sx={{ marginTop: '10px' }}>
                  //       <FormControlLabel control={<Checkbox />} label="Registration" />
                  //       <FormControlLabel control={<Checkbox />} label="Readonly" />
                  //       <FormControlLabel control={<Checkbox />} label="Device Readonly" />
                  //       <FormControlLabel control={<Checkbox />} label="Limit Commands" />
                  //       <FormControlLabel control={<Checkbox />} label="Disable Reports" />
                  //       <FormControlLabel control={<Checkbox />} label="No Email Change" />
                  //     </FormGroup>
                  //   </Select>
                  // </FormControl>
<FormControl fullWidth sx={{ marginBottom: '10px' }} key={col.accessor} required>
