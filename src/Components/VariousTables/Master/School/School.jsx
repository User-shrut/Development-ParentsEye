...
import MOCK_DATA from './MOCK_DATA.json'; // Import your data here
...
export const School = ({data}) => {
  ...
  const handleExport = () => {
    ...
    XLSX.writeFile(workbook, "Assets_Command_List.xlsx");
  };
  ...
  return (
    <>
      <h2 style={{ textAlign: 'center' }}>Assets Command List</h2>
      <div>
