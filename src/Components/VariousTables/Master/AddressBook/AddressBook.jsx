...
export const AddressBook = ({data}) => {
  ...
  const handleExport = () => {
    ...
    XLSX.writeFile(workbook, "Address_Book.xlsx");
  };
  ...
  return (
    <>
      <h2 style={{ textAlign: 'center' }}>Address Book</h2>
      <div>
      ...
      <Modal open={addModalOpen} onClose={handleModalClose}>
        <Box sx={style}>
          <h2>Add New Row</h2>
          {COLUMNS().map((column) => (
            (column.Header === 'Name' || column.Header === 'Mobile Number' || column.Header === 'Email')&& ( 
              // column.accessor === 'id' ?
              <TextField
                key={column.accessor}
            ...
            margin="normal"
          >
            <MenuItem value="All assets">School</MenuItem>
