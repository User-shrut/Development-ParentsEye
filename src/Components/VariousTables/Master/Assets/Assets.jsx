...
//   return (
//     <>
//       <h1 style={{ textAlign: 'center', marginTop:'113px' }}>Assets List</h1>
//       <div>
...
//             sx={{ marginRight: '10px', width: '200px', '& .MuiInputBase-root': { height: 40 } }}
//             InputProps={{
//               startAdornment: (
...
//                 <TableCell
//                   padding="checkbox" style={{ borderRight: '1px solid #e0e0e0',borderBottom:'1px solid black' }}>
//                   <Switch
//                     checked={selectAll}
...
import {
  ...
  TablePagination, TableRow, TextField, Button, Modal, Box, Switch,
  Alert, Snackbar, Select, MenuItem
} from '@mui/material';
import {
  Search as SearchIcon, ArrowUpward as ArrowUpwardIcon,
  ArrowDownward as ArrowDownwardIcon, Delete as DeleteIcon,
  Edit as EditIcon, ImportExport as ImportExportIcon,
  AddCircle as AddCircleIcon, CloudUpload as CloudUploadIcon
...
export const Assets = ({ data = MOCK_DATA }) => {
  const [page, setPage] = useState(0);
  const [rowsPerPage, setRowsPerPage] = useState(10);
  const [filterText, setFilterText] = useState('');
      ...
      <div>
        ...
        <Modal open={editModalOpen} onClose={handleModalClose}>
          <Box sx={style}>
            ...
            <Button onClick={handleEditSubmit} variant="contained" color="primary" sx={{ marginTop: '10px' }}>
              Save
            </Button>
            <Button onClick={handleModalClose} variant="contained" color="error" sx={{ marginTop: '10px' }}>
              Cancel
            </Button>
          </Box>
        </Modal>
        <Modal open={addModalOpen} onClose={handleModalClose}>
          <Box sx={style}>
            ...
            <Button onClick={handleAddSubmit} variant="contained" color="primary" sx={{ marginTop: '10px' }}>
              Add
            </Button>
            <Button onClick={handleModalClose} variant="contained" color="error" sx={{ marginTop: '10px' }}>
              Cancel
        ...
        <Modal open={importModalOpen} onClose={() => setImportModalOpen(false)}>
          <Box sx={style}>
            ...
            {importData.length > 0 && (
              <>
                <TableContainer sx={{ maxHeight: 300, marginTop: '10px' }}>
                  <Table stickyHeader>
                    <TableHead>
                      <TableRow>
                ...
                <Button
                  onClick={() => {
                    setFilteredRows([...filteredRows, ...importData.map(row => ({ ...row, isSelected: false }))]);
