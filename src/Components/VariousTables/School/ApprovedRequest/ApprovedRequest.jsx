...
//         "https://schoolmanagement-uz4r.onrender.com/school/approved-requests",
//         {
//           headers: {
...
//   //       setFilteredRows(response.data.children.map(row => ({ ...row, isSelected: false })));
//   //       setTotalResponses(response.data.children.length);
//   //     } else {
...
//     // If data structure has a 'requests' property, check for children inside it
...
//       const apiUrl = 'https://schoolmanagement-10.onrender.com/school/delete';
...
//     const apiUrl = `https://schoolmanagement-10.onrender.com/school/update/${selectedRow._id}`; // Replace with your actual API URL
...
//   return (
//     <>
//       <h1 style={{ textAlign: 'center',marginTop:'113px' }}>Approved Request list </h1>
//       <div>
...
//       const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2YjRhMDdmMGRkYmVjNmM3YmMzZDUzZiIsInVzZXJuYW1lIjoiYWRtaW4iLCJpYXQiOjE3MjMxMTU1MjJ9.4DgAJH_zmaoanOy4gHB87elbUMod8PunDL2qzpfPXj0"; // Replace with actual token
//       const response = await axios.get(
//         "https://schoolmanagement-4-pzsf.onrender.com/school/approved-requests",
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
